          ...
          <div className="grid grid-cols-1 gap-6">
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  <h4 className="text-lg font-semibold text-lg">{t('about.skills.dataAnalysis.title')}</h4>
                  <p className="text-muted-foreground">
            ...
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  <h4 className="text-lg font-semibold text-lg">{t('about.skills.consulting.title')}</h4>
                  <p className="text-muted-foreground">
            ...
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  <h4 className="text-lg font-semibold text-lg">{t('about.skills.automation.title')}</h4>
                  <p className="text-muted-foreground">
